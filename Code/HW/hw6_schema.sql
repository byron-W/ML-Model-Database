...
(1, "Mystik Dan", "colt", "Goldencents", "Maam", "active", "bay", "USA", '2021-03-04'),
...
(5, "Linebacker", "gelding","Nyquist","Elusive Checkers", "active","bay", "USA", '2021-09-01'),
(6, "Droptop Caddy","colt", "Uncle Mo", "Jumby Bay", "active", "brown","USA",'2021-04-29');
...
(1,21,"Brian Hernandez Jr.", 2, 20000),
(3,21,"Declan Cannon", 1, 63000),
(5,21,"Luis Saez",3,10000),
(6,21,"Edgar Morales",4,7000),
(1,22,"Julien Leparoux",5, 0),
(4,23,"Declan Cannon",3,3800);
